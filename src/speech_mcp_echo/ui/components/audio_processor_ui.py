...
from speech_mcp_echo.constants import TRANSCRIPTION_FILE

# Import shared audio processor and speech recognition
from speech_mcp_echo.audio_processor import AudioProcessor
from speech_mcp_echo.speech_recognition import transcribe_audio
...
class AudioProcessorUI(QObject):
    ...
    def _initialize_speech_recognition(self):
        ...
        try:
            ...
            from speech_mcp_echo.speech_recognition import initialize_speech_recognition
