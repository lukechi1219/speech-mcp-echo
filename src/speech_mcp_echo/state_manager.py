"""
StateManager module for centralized state management in speech-mcp-echo.
...
class StateManager:
    ...
    def _persist_state(self) -> None:
        ...
        try:
            config_dir = Path(os.path.expanduser('~/.config/speech-mcp-echo'))
            config_dir.mkdir(parents=True, exist_ok=True)

            state_file = config_dir / 'state.json'

            # Only persist certain keys
            persist_keys = {'voice_preference', 'debug_mode', 'stt_engine', 'tts_engine', 'summarizer_enabled'}
    ...
    def _load_persisted_state(self) -> None:
        ...
        try:
            state_file = Path(os.path.expanduser('~/.config/speech-mcp-echo/state.json'))
