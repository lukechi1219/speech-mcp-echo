"""
Centralized constants for speech-mcp-echo.

This module provides constants used throughout the speech-mcp-echo extension.
...
# Log files
SERVER_LOG_FILE = os.path.join(BASE_DIR, "speech-mcp-echo-server.log")
UI_LOG_FILE = os.path.join(BASE_DIR, "speech-mcp-echo-ui.log")
MAIN_LOG_FILE = os.path.join(BASE_DIR, "speech-mcp-echo.log")
...
# Configuration paths
CONFIG_DIR = os.path.join(str(Path.home()), '.config', 'speech-mcp-echo')
CONFIG_FILE = os.path.join(CONFIG_DIR, 'config.json')

# Environment variable names
ENV_TTS_VOICE = "SPEECH_MCP_ECHO_TTS_VOICE"
ENV_TTS_ENGINE = "SPEECH_MCP_ECHO_TTS_ENGINE"
ENV_STT_ENGINE = "SPEECH_MCP_ECHO_STT_ENGINE"
